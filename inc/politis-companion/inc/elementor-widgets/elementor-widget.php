    ...
    final class Politis_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            /******************
                Enqueue Css
            ******************/
            wp_enqueue_style( 'owl-carousel', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/css/owl.carousel.css', array(), '2.2.0', 'all' );
            wp_enqueue_style( 'magnific-popup', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/css/magnific-popup.css', array(), '3.7.0', 'all' );
            ...
            ******************/
            ...
            // ajaxchimp js
            wp_enqueue_script( 'jquery-ajaxchimp', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/jquery.ajaxchimp.min.js', array('jquery'), '1.0', true );

            // jquery owl carousel
            wp_enqueue_script( 'owl-carousel', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/owl.carousel.min.js', array('jquery'), '2.2.0', true );

            // jquery waypoints js
            wp_enqueue_script( 'jquery-magnific-popup', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/jquery.magnific-popup.min.js', array('jquery'), '1.0', true );

            // jquery accordion js
           wp_enqueue_script( 'mm-accordion', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/mn-accordion.js', array('jquery'), '1.0', true );
           
            // jquery waypoints js
           wp_enqueue_script( 'waypoints', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/waypoints.min.js', array('jquery'), '1.0', true );

            // jquery counterup js
           wp_enqueue_script( 'jquery-counterup', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/jquery.counterup.min.js', array('jquery'), '1.0', true );

            // politis map custom js
            wp_register_script( 'politis-map-custom', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/map-custom.js', array('jquery'), '1.0', true );

            // politis companion main js
            wp_enqueue_script( 'politis-companion', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/js/politis-companion-main.js', array( 'jquery', 'jquery-ui-datepicker' ), '1.0', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'politis-companion-elementor-edit', POLITIS_COMPANION_DIR_URL . 'inc/elementor-widgets/assets/css/elementor-edit.css' );
        }

...
function politis_import_files() {
	...
	$demoImg = '<img src="'.POLITIS_COMPANION_DIR_URL . 'inc/demo-data/screen-image.png' .'" alt="'.esc_attr__( 'Demo Preview Imgae', 'politis-companion' ).'" />';
  ...
  return array(
    array(
      ...
      'import_customizer_file_url'   => POLITIS_COMPANION_DIR_URL . 'inc/demo-data/politis-customizer.dat',
...
function politis_demo_import_custom_scripts(){
	...
	if( isset( $_GET['page'] ) && $_GET['page'] == 'politis-demo-import' ){
		// style
		wp_enqueue_style( 'politis-demo-import', POLITIS_COMPANION_DIR_URL . 'inc/demo-data/css/demo-import.css', array(), '1.0', false );
	}

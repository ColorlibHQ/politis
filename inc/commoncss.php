...
// enqueue css
function politis_common_custom_css() {
    
    wp_enqueue_style( 'politis-common', get_template_directory_uri().'/assets/css/common.css' );
		
		$headerBg          =  ! empty( get_header_image() ) ? 'url(' . esc_url( get_header_image() ) . ')' : '';
		$headerTextColor   = esc_attr( politis_opt( 'politis_headertextcolor', '#fff' ) );
		$headerbgcolor     = esc_attr( politis_opt( 'politis_headerbgcolor' ) );
		$headerOverlay     = esc_attr( politis_opt( 'politis_headeroverlaycolor' ) );
		$navbarbg 		   = esc_attr( politis_opt( 'politis_header_navbar_bgColor', '#fff' ) );
		$stickynavbarbg    = esc_attr( politis_opt( 'politis_header_navbarsticky_bgColor', '#fff' ) );
		$navmenuColor 			= esc_attr( politis_opt( 'politis_header_navbar_menuColor', '#222' ) );
		$navmenuHovColor 		= esc_attr( politis_opt( 'politis_header_navbar_menuHovColor', '#222' ) );
		$stickynavmenuColor 	= esc_attr( politis_opt( 'politis_header_sticky_navbar_menuColor', '#222' ) );
		$stickynavmenuHovColor 	= esc_attr( politis_opt( 'politis_header_sticky_navbar_menuHovColor', '#222' ) );
		$foftext1     	   = esc_attr( politis_opt( 'politis_fof_textonecolor_settings' ) );
		$foftext2     	   = esc_attr( politis_opt( 'politis_fof_texttwocolor_settings' ) );
		$fofbgcolor        = esc_attr( politis_opt( 'politis_fof_bgcolor_settings' ) );
		$footerbgImg       = politis_opt( 'politis_footer_bgimg_settings' );
		...
		$footerbgColor     = esc_attr( politis_opt( 'politis_footer_widget_bgColor_settings' ) );
		$footerTextColor   = esc_attr( politis_opt( 'politis_footer_widget_color_settings', '#fff' ) );
		$anchorcolor 	   = esc_attr( politis_opt( 'politis_footer_widget_anchorcolor_settings', '#fff' ) );
		$anchorhovcolor    = esc_attr( politis_opt( 'politis_footer_widget_anchorhovcolor_settings', '#3898f8' ) );
		$widgettitlecolor  = esc_attr( politis_opt( 'politis_footer_widgettitlecolor_settings' ) );
		$themecolor  	   = esc_attr( politis_opt( 'politis_themecolor' ) );

		$footerbtombg  	   			= esc_attr( politis_opt( 'politis_footer_bottom_bgcolor_settings' ) );
		$footerbtomtextcolor 		= esc_attr( politis_opt( 'politis_footer_bottom_textcolor_settings' ) );
		$footerbtomanchorcolor 		= esc_attr( politis_opt( 'politis_footer_bottom_anchorcolor_settings' ) );
		$footerbtomanchorhovercolor = esc_attr( politis_opt( 'politis_footer_bottom_anchorhovercolor_settings' ) );
    ...
    wp_add_inline_style( 'politis-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'politis_common_custom_css', 50 );
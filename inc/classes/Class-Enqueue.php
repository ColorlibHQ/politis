...
class Politis_Enqueue {

	public $scripts = array();

	public function politis_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'politis_frontend_enqueue_scripts', ) );
	}

	public function politis_frontend_enqueue_scripts( ) {

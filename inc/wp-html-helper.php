...
// image default alt
if( ! function_exists( 'politis_img_default_alt' ) ) {
	function politis_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'politis_img_tag' ) ) {
	function politis_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = politis_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'politis_anchor_tag' ) ) {
	function politis_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'politis' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'politis_heading_tag' ) ) {
	function politis_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'politis' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'politis_paragraph_tag' ) ) {
	function politis_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'politis_other_tag' ) ) {
	function politis_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'politis_button_element ' ) ) {
	function politis_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'politis' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',

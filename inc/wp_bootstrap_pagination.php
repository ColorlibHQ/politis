...
function politis_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'politis' ),
        'next_string'     => esc_html__( '&raquo;', 'politis' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'politis_pagination_defaults', $defaults )
    );
